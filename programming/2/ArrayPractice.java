 ...
 * First Last
 * collaborators: Maxwell Yearwood, Richard Parker, Joshua Higgins, and Steve Sabaugh
 */
...
public class ArrayPractice
{
  ...
  */
  public static int firstOccurence( int[] data, int value )
  {
    ...
    return data.length; // change this (it is just a placeholder to "get past" the compiler)
  }
  ...
  */
  ...
  public static void main( String[] args )
  {
    ...
    System.out.println("What is the sum of the array elements?" + arraySum(data));
    ...
    // Count odds
    System.out.println(" The number of odd elements are:" + countOdds(data));
